            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a class="volatility-lnk" href="<?php echo site_url('volatility'); ?>">Volatility</a></li>
                        <li><a class="portfolio-lnk" href="<?php echo site_url('portfolio'); ?>">Portfolio</a></li>
                        <li><a class="journal-lnk" href="<?php echo site_url('journal'); ?>">Journal</a></li>
                    </ul>
